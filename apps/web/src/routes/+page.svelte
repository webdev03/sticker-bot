...
>
  <div class="md:w-[40%]">
    <h1 class="text-3xl font-bold">Welcome to Sticker Bot!</h1>

    <!--
    This is from https://api.slack.com/authentication/sign-in-with-slack#generator
  -->
    <a
      class="mt-3"
      href="/sign-in"
    ...
    <p class="mt-6 italic">
      Signing in with Slack will give you access to the website to view
      stickers, while opening the channel in Slack will send you to the Sticker
      Bot channel where you can create stickers
    </p>
  </div>
</div>
